...
<body>
  ...
  <div id="our-beginning" class="page-section" data-matching-link="#our-beginning-link"> <!--custom attributes start with data. The # selects elements with an id-->
	  <div class="wrapper">
		...
		<div class="wrapper wrapper--medium wrapper--b-margin">
			<!--(min-width: 970px) 976px impone che solo per schermi più grandi di 970 si usi la 976px, per schermi più piccoli deve occupare 100% 
			del device width (vw = viewport width)-->
		...
		<div class="row row--gutters">
			<div class="row__medium-4 row__medium-4--larger row__b-margin-until-medium">
				<picture>
					<!--di default le responsive images prendono tutta la larghezza e quindi il browser prende la versione HD. sizes dice al browser che l'immagine 
					non sarà più grande di 404px e quindi prende quella adatta-->
					<source class="lazyload" sizes="404px" data-srcset="assets/images/our-start-i.jpg 404w, assets/images/our-start-hi-dpi-i.jpg 808w" media="(min-width: 1020px)">
					<source class="lazyload" sizes="320px" data-srcset="assets/images/our-start-portrait-i.jpg 382w, assets/images/our-start-portrait-hi-dpi-i.jpg 764w" media="(min-width: 800px)">
		...
		<div class="row row--gutters row--equal-height-at-large row--gutters-small row--t-padding generic-content-container">
			...
			<div class="row__large-4">
				<div class="testimonial testimonial--last">
						<div class="testimonial__photo">
							<img class="lazyload" sizes="160px" data-srcset="assets/images/testimonial-cat-i.jpg 160w, assets/images/testimonial-cat-hi-dpi-i.jpg 320w" alt="Cat McKitty">
						</div>
					<h3 class="testimonial__title">Cat McKitty</h3>
					<h4 class="testimonial__subtitle">6 Time Escaper</h4>
					<p>&ldquo;Duis aue irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut.&rdquo;</p>
				</div>
			</div>
		</div>
	</div>
