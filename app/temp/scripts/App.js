...
/***/ (function(module, exports, __webpack_require__) {
	...
	var MobileMenu = function () {
		function MobileMenu() {
			...
			//parte eseguita subito appena la classe viene chiamata

			//new properties
			this.siteHeader = (0, _jquery2.default)(".site-header"); //selects the entire header element from the DOM
			this.menuIcon = (0, _jquery2.default)(".site-header__menu-icon"); //selezione dell'elemento icona del menu
	...
	exports.default = MobileMenu; //per esportare la classe all'esterno
		...
		_createClass(RevealOnScroll, [{
			...
			value: function createWaypoints() {
				...
				this.itemsToReveal.each(function () {
					// ".each" allows to run code once for each element
			...
			value: function createHeaderWaypoint() {
				...
				new Waypoint({
					...
					handler: function handler(direction) {
						//with [0] we can access the native DOM element of the jquery object.
						if (direction == "down") {
	...
	var Modal = function () {
		...
		_createClass(Modal, [{
			...
			value: function events() {
				...
				(0, _jquery2.default)(document).keyup(this.keyPressHandler.bind(this)); //$(document) selects entire document
			}
		}, {
			key: "keyPressHandler",
			value: function keyPressHandler(e) {
				if (e.keyCode == 27) {
					//escape key has a value of 27
					this.closeModal();
				}
			}
		}, {
